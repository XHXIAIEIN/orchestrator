...
- Full protocol: `.claude/skills/verification-check/SKILL.md` (post-verify) and `.claude/skills/verification-spec/SKILL.md` (pre-verify)

<!-- source: CLAUDE.md §Verification Gate, extracted 2026-04-18 -->
